...
\td{Add the continuous-valued version of the polar maps, time plots.}

\section{Acoustically Shared Science Data}
\td{Plots of how the science monitor would look compared to the real signal.}

\section{Field Report}
\td{Put a shortened copy of the field report from the cruise in.}

\section{Code and Data Availability}
\td{Might be nice to link to the processing code here, and have some brief documentation on it.}